...
| [acquisition-layout-contract.md](acquisition-layout-contract.md) | Active — PR 1-6 implemented (schema, transport, resolver, producers, MoNaLISA/BeadRec/SNOUTY/SMLM), PR 7 and rig validation pending | Versioned frame-layout metadata from scan producers through recording and reconstruction |
