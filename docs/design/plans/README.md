...
| [generalized-scan-order-model.md](generalized-scan-order-model.md) | Proposed — design only, land after rig validation | Affine loop-to-coordinate scan order and detector rank, generalizing the acquisition layout |
