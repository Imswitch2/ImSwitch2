...
| [scanner-calibration-widget.md](scanner-calibration-widget.md) | Proposed — P-0 (manual per-axis voltage entry) agreed as first deliverable; point-detector probe and field nonlinearity cut | Manual scanner DAC control and camera-based measurement of scanner calibration constants |
