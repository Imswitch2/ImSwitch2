...
| [magic-number-audit.md](magic-number-audit.md) | Reference — 2026-09-10/11; 32 verified, 10 refuted, 12 unchallenged leads; 12 fixed on the branch (7 verified + 5 leads settled by their fix) | Constants and defaults that are right for the case they were written for and silently wrong for a neighbour; the shape, and where else the tree has it |
