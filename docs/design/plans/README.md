...
| [acquisition-layout-direction-audit.md](acquisition-layout-direction-audit.md) | Reference — 2026-09-03; condition 3 done, conditions 1, 2, 4–7 open | Verdict on whether the layout contract is the final answer to scan geometry/order: direction right, five verified defects, ordered conditions checklist |
