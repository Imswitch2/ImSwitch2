...
| [acquisition-layout-contract.md](acquisition-layout-contract.md) | Active — PR 1-5 implemented (schema, transport, resolver, producers, MoNaLISA/BeadRec), PR 6-7 and rig validation pending | Versioned frame-layout metadata from scan producers through recording and reconstruction |
