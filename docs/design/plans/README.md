...
| [improcess-graph-and-wfs-analysis.md](improcess-graph-and-wfs-analysis.md) | Active — graph widget first, WFS reconstructor later | General ImProcess plotting surface and WidefieldSTARSS analysis integration |
