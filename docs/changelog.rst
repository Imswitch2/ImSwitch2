...
- TriggerScope scans now emit scan-start before firmware commands, and an abort stops repeat scans without interrupting the iteration already in progress.
