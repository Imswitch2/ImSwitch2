...
| [memory-budgets.md](memory-budgets.md) | Proposal — 2026-09-21, rounds 3-4: three named limits, no total; Phase A (oversized raw volume dropped at the detector boundary) FIXED d648967d, rest unimplemented | One declared memory budget per module with derived shares, instead of a preference per byte constant; why VRAM waits |
