...
| [acquisition-layout-direction-audit.md](acquisition-layout-direction-audit.md) | Reference — 2026-09-03; conditions 1–3 done, conditions 4–7 open | Verdict on whether the layout contract is the final answer to scan geometry/order: direction right, five verified defects, ordered conditions checklist |
