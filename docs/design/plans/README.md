...
| [memory-budgets.md](memory-budgets.md) | Proposal — 2026-09-21, round 3 reversed rounds 1-2: three named limits, no total; found a PR #29 regression (oversized raw volume dropped) | One declared memory budget per module with derived shares, instead of a preference per byte constant; why VRAM waits |
