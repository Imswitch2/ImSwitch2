...
class TriggerScopeLSXYRWidget(Widget):
    """Widget for the TriggerScope LS-XY-RESOLFT scan."""
    ...
    def setRasterXScanDevice(self, value):
        self.rasterXScanDeviceEdit.setCurrentIndex(self.rasterXScanDeviceEdit.findText(value))

    def getRasterYScanDevice(self):
        return self.rasterYScanDeviceEdit.currentText()

    def setRasterYScanDevice(self, value):
        self.rasterYScanDeviceEdit.setCurrentIndex(self.rasterYScanDeviceEdit.findText(value))
