...
class TriggerScopeGalvoDetectionWidget(Widget):
    """Widget for the TriggerScope pLS-RESOLFT galvo-detection scan."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        galvoFirstPositionLabel = QtWidgets.QLabel('Galvo scan first position (um)')
        self.galvoFirstPositionEdit = guitools.BetterDoubleSpinBox(allowScrollChanges=False)
        self.galvoFirstPositionEdit.setMinimum(-500)
        self.galvoFirstPositionEdit.setMaximum(500)
        self.galvoFirstPositionEdit.editingFinished.connect(self.sigParameterChanged)

        galvoSecondPositionLabel = QtWidgets.QLabel('Galvo scan second position (um)')
        self.galvoSecondPositionEdit = guitools.BetterDoubleSpinBox(allowScrollChanges=False)
        self.galvoSecondPositionEdit.setMinimum(-1000)
        self.galvoSecondPositionEdit.setMaximum(1000)
        self.galvoSecondPositionEdit.editingFinished.connect(self.sigParameterChanged)

        galvoThirdPositionLabel = QtWidgets.QLabel('Galvo scan third position (um)')
        self.galvoThirdPositionEdit = guitools.BetterDoubleSpinBox(allowScrollChanges=False)
        self.galvoThirdPositionEdit.setMinimum(-1000)
        self.galvoThirdPositionEdit.setMaximum(1000)
        self.galvoThirdPositionEdit.editingFinished.connect(self.sigParameterChanged)
        ...
        galvoScanDeviceLabel = QtWidgets.QLabel('scan detection device')
        self.galvoScanDeviceEdit = guitools.BetterComboBox(allowScrollChanges=False)
        ...
        self.grid.addWidget(galvoScanDeviceLabel, currentRow, 2)
        self.grid.addWidget(self.galvoScanDeviceEdit, currentRow, 3)
        currentRow += 1
        self.grid.addWidget(roLaserLabel, currentRow, 0)
        self.grid.addWidget(self.roLaserEdit, currentRow, 1)
        self.grid.addWidget(galvoFirstPositionLabel, currentRow, 2)
        self.grid.addWidget(self.galvoFirstPositionEdit, currentRow, 3)
        currentRow += 1
        self.grid.addWidget(galvoSecondPositionLabel, currentRow, 0)
    ...
    def getGalvoScanDevice(self):
        return self.galvoScanDeviceEdit.currentText()
    ...
    def getGalvoFirstPositionUm(self):
        return self.galvoFirstPositionEdit.value()

    def setGalvoFirstPositionUm(self, value):
        self.galvoFirstPositionEdit.setValue(value)

    def getGalvoSecondPositionUm(self):
        return self.galvoSecondPositionEdit.value()

    def setGalvoSecondPositionUm(self, value):
        self.galvoSecondPositionEdit.setValue(value)

    def getGalvoThirdPositionUm(self):
        return self.galvoThirdPositionEdit.value()

    def setGalvoThirdPositionUm(self, value):
        self.galvoThirdPositionEdit.setValue(value)
