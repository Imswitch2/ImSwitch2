...
| [acquisition-layout-contract.md](acquisition-layout-contract.md) | Proposed | Versioned frame-layout metadata from scan producers through recording and reconstruction |
