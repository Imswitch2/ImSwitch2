...
class TriggerScopeGalvoDetectionController(ImConWidgetController):
    ...
    def setParameters(self):
        ...
        try:
            ...
            self._widget.setGalvoFirstPositionUm(self._scanParameterDict['galvoFirstPositionUm'])
            self._widget.setGalvoSecondPositionUm(self._scanParameterDict['galvoSecondPositionUm'])
            self._widget.setGalvoThirdPositionUm(self._scanParameterDict['galvoThirdPositionUm'])
    ...
    def runScanAdvanced(self, *, recalculateSignals=True, isNonFinalPartOfSequence=False,
        ...
        try:
            ...
            self._master.scanManager.runScan(triggerscopeParameters, scan_type='GalvoDetectionScan')
        except Exception:
    ...
    def getParameters(self):
        ...
        self._scanParameterDict['galvoFirstPositionUm'] = self._widget.getGalvoFirstPositionUm()
        self._scanParameterDict['galvoSecondPositionUm'] = self._widget.getGalvoSecondPositionUm()
        self._scanParameterDict['galvoThirdPositionUm'] = self._widget.getGalvoThirdPositionUm()
