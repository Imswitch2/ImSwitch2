...
IMPROCESS_ICON_NAMES = {
    ...
    "graph": "fa6s.chart-line",
    "profile": "mdi6.vector-line",
    "roi-manager": "mdi6.select-marker",
    "roi-stats": "mdi.format-list-numbered",
    "projection": "mdi6.axis-arrow",
    "segmentation": "ph.user-rectangle-fill",
    "metadata": "mdi6.file-tree",
...
_FALLBACK_STANDARDS = {
    ...
    "graph": QtWidgets.QStyle.SP_FileDialogDetailedView,
    "profile": QtWidgets.QStyle.SP_TitleBarShadeButton,
    "roi-manager": QtWidgets.QStyle.SP_FileDialogListView,
    "roi-stats": QtWidgets.QStyle.SP_FileDialogDetailedView,
    "projection": QtWidgets.QStyle.SP_ArrowDown,
    "segmentation": QtWidgets.QStyle.SP_DialogApplyButton,
    "metadata": QtWidgets.QStyle.SP_FileDialogInfoView,
