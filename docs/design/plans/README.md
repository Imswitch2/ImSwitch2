...
| [acquisition-layout-contract.md](acquisition-layout-contract.md) | Active — PR 1-4 implemented (schema, transport, resolver, producers), reconstructor migrations and rig validation pending | Versioned frame-layout metadata from scan producers through recording and reconstruction |
