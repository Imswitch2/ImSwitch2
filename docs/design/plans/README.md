...
| [magic-number-audit.md](magic-number-audit.md) | Reference — 2026-09-10; 17 verified, 36 unverified leads, 3 fixed | Constants and defaults that are right for the case they were written for and silently wrong for a neighbour; the shape, and where else the tree has it |
