...
| [memory-budgets.md](memory-budgets.md) | Proposal — 2026-09-21, rounds 1-2 resolved (7 P1), shape decided | One declared memory budget per module with derived shares, instead of a preference per byte constant; why VRAM waits |
